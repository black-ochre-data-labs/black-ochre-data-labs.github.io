...
### Adding team members
- Upload img (150px circle w/ transparent background) to `/assets/img/team/firstname-lastname.png`
- Update `_data/people.yaml` to add the person's information with at least: name, email, img


## Support
For further support or if you have any questions about the website, contact [Holly Massacci](mailto:hollym@blackochrelabs.au)
